...
"PO-Revision-Date: 2020-02-05 19:33+0000\n"
"Last-Translator: b'  <me@gmail.com>'\n"
...
msgstr ""
"Не удалось загрузить указанный языковой файл. Это обычно происходит, когда "
"используется серверная часть хранилища зашифрованных файлов cookie в Django "
"1.4 или выше. <br/> Установка ROSETTA_STORAGE_CLASS = "
"'rosetta.storage.CacheRosettaStorage' в файле настроек должна исправить это."
...
msgstr ""
"Вы не указали языки в своем файле настроек или еще не создали партию "
"каталогов переводов."
...
" project."
msgstr ""
"Обратитесь к <a href=\"%(i18n_doc_link)s\"> документации Django по I18N "
"</a>, чтобы узнать, как настроить интернационализацию для вашего проекта."
...
msgstr ""
"Не удалось сохранить некоторые элементы в вашем последнем блоке перевода: "
"обычно это происходит, когда файл каталога изменяется на диске после его "
"последней загрузки."
...
msgstr[0] "%(more_count)s  ещё"
msgstr[1] "%(more_count)s  ещё"
msgstr[2] "%(more_count)s  ещё"
